...
- Added a scheduled GitHub Actions workflow that builds the alignments against each new IPD-IMGT/HLA release and reports a failure if the new data breaks the parser.
